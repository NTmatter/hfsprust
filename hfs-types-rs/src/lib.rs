...
pub struct JournalInfoBlock {
    /// Journal flags described by `JournalInfoBlockFlag`
    pub flags: u32,
...
pub struct BlockInfo {
    ...
    /// Number of bytes to copy from Journal Buffer to `into_sector`.
